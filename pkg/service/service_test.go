...
func (m *ManagerTestSuite) SetUpTest(c *C) {
	...
	m.prevOptionLBSourceRanges = option.Config.EnableLoadBalancerSourceRangesCheck
	option.Config.EnableLoadBalancerSourceRangesCheck = true
}
...
func (m *ManagerTestSuite) TearDownTest(c *C) {
	...
	option.Config.EnableLoadBalancerSourceRangesCheck = m.prevOptionLBSourceRanges
}
